...
const Member = () => {
  ...
  return (
    ...
    //                 required
    //               />
    //               <span className="error">{getError.date}</span>{" "}
    //             </td>
    //           </tr>
    ...
    //                 required
    //               />
    //               <span className="error">{getError.father}</span>
    //             </td>
    //             <td>Mother Name:</td>
    //             <td>
    //               <input
    ...
    //                 required
    //               />
    //               <span className="error">{getError.mother}</span>{" "}
    //             </td>
    //           </tr>
    //           <tr>
    //
